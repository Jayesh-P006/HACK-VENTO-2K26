...
def get_upcoming_drives():
    ...
    future_visits = CompanyVisit.query.filter(
        CompanyVisit.visit_date >= datetime.utcnow(),
    ...
    for visit in future_visits:
        ...
        result.append({
            ...
            'visit_time': visit.visit_time or 'TBD',
...
def register_drive_interest(visit_id):
    ...
    notification = Notification(
        ...
        type='company_visit',
        title=f'Registered for {visit.company_name}',
        message=f'You have registered for the recruitment drive on {visit.visit_date.date()}',
