  ...
  createCard(app) {
    return `
      <div class="kanban-card animate" data-app-id="${app.id}" draggable="true">
        ...
        ${app.interview_date ? `<div class="chip" style="margin-top: 6px; background: rgba(20, 184, 166, 0.1); border-color: rgba(20, 184, 166, 0.3); color: #0d9488;">📅 ${new Date(app.interview_date).toLocaleDateString()}</div>` : ''}
